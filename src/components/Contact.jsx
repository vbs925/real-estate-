...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "c7fcb6dc-d069-4e68-99f9-41d59c535bc1");
  ...
  return (
    ...
    className='test-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
        ...
        <form onSubmit={onSubmit}   className='max-w-2xl mx-auto text-gray-600 pt-8' >
            ...
            <button className='bg-blue-600 text-white text-center py-2 px-12 mb-10 rounded'> {Result ? Result: "Send Message"}</button>
        </form>
