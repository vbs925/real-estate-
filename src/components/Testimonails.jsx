...
const Testimonails = () => {
  return (
    ...
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id ='Testimonials'>
        ...
        <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real Stories from thoese who found home with us</p>
        ...
        <div className='flex flex-wrap justify-center gap-8'>
            {testimonialsData.map((testimonial,index)=>(
                <div key={index} className='max-w-[340px] border shadow-lg rounded px-8 py-12 text-center'>
                    ...
                    <h2 className='test-xl tes-gray-700 font-medium'>{testimonial.name}</h2>
                    <p className='test-gray-500 mb-4 test-sm'>{testimonial.title}</p>
                    <div className='flex justify-center gap-1 test-red-500 mb-4'>
